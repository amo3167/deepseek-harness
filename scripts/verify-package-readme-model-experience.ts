...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-advisor-selection': { kind: 'indirect', reason: 'The global picker changes advisor settings; the advisor service owns consultation requests and model-visible effects.' },
